...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="cifar100",
        choices=["cifar10", "cifar100", "imagenet", "tiny_imagenet", "cinic10_clean_cifar_size"],
    )
    ...
    elif args.dataset in ("cifar10", "cifar100", "tiny_imagenet", "cinic10_clean_cifar_size"):
        if args.dataset in ("cifar10", "cinic10_clean_cifar_size"):
