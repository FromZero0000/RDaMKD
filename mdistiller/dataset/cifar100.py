...
def get_cifar100_train_transform(strong=False):
...
def get_cifar100_dataloaders(
    batch_size, val_batch_size, num_workers, strong=False
):
    data_folder = get_data_folder()
    train_transform = get_cifar100_train_transform(strong=strong)
