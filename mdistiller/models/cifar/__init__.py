...
cifar_model_dict = {
    ...
    # CIFAR-10 teachers for CIFAR-10 -> CINIC-10 transfer
    "cifar10_resnet56": (
        resnet56,
        cifar10_model_prefix + "resnet56_vanilla/ckpt_epoch_200.pth",
    ),
    "cifar10_resnet110": (
        resnet110,
        cifar10_model_prefix + "resnet110_vanilla/ckpt_epoch_200.pth",
    ),
    # students
